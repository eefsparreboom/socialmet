...
function bootstrapBasicEnqueueScripts() 
{
	...
	wp_enqueue_script('bxslider-script', get_template_directory_uri() . '/js/vendor/jquery.bxslider.min.js');
...
require get_template_directory() . '/inc/widgets/NewsArchiveWidget.php';
function bb_register_widgets() {
	register_widget( 'NewsArchiveWidget' );
	
}

add_action( 'widgets_init', 'bb_register_widgets' );