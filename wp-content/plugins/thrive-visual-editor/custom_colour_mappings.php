        ...
        "1" => array(
            "Flat" => array(
                0 => array(
                    ...
                    "selector" => '.thrv_lead_generation_container button',
                    "property" => 'color',
                    "value" => "[color]",
                ),
                1 => array(
        ...
        'undefined' => array(
            "Flat" => array(
                ...
                array(
                    "label" => "Border color",
                    "selector" => ".tve_p_lb_content",
                    'additional_elements' => '.tve_p_lb_content .tve_p_lb_close',
                    'search_outside' => 1,
                    "property" => "border-color",
            ...
            "Classy" => array(
                ...
                array(
                    "label" => "Border color",
                    "selector" => ".tve_p_lb_content,.tve_p_lb_content .tve_p_lb_close",
                    'search_outside' => 1,
                    "property" => "border-color",
                    'global_save_key' => 'l_cb', // lightbox_content_border
                    "value" => "[color]",
