...
<div class="tve_lp_content tve_editor_main_content tve_empty_dropzone thrv_wrapper tve_no_drag" style="margin-top: 70px; max-width: 1080px; background-attachment: scroll;">
    ...
    <h1 class="tve_p_center" style="font-weight: 100; font-size: 52px; margin-bottom: 60px; margin-top: 0px;">
    ...
    <h1 class="tve_p_center" style="font-weight: 100; font-size: 52px; margin-bottom: 60px;">
    ...
    <h1 class="tve_p_center" style="font-weight: 100; font-size: 52px; margin-bottom: 60px; margin-top: 80px;">
    ...
    <h1 class="tve_p_center" style="font-weight: 100; font-size: 52px; margin-bottom: 60px; margin-top: 160px;">Yes, <span class="bold_text">Now</span> it's Finally Time for the Big Reveal&nbsp;-
    ...
    <h1 class="tve_p_center" style="font-weight: 100; font-size: 52px; margin-bottom: 60px;">Address Your Visitor's <span class="bold_text">Last-Minute Objections</span></h1>
