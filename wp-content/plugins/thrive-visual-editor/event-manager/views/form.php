...
<div class="tve_event_manager" id="tve_current_event_settings">
    <table class="tve_event_manager_list">
        ...
        <tr>
            <td>
                <select name="t" id="tve_event_trigger" class="tve_ctrl_validate" data-validators="required">
    ...
    <div id="tve_event_settings">
        <?php /** @var TCB_Event_Action_Abstract $selected_action */ ?>
        <?php if (!empty($selected_action)) : ?>
            <?php $selected_action->renderSettings(array('config' => $config)); ?>
        <?php endif ?>
    </div>
