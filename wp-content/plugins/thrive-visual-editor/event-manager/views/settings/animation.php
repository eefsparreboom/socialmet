...
<table class="tve_no_brdr">
    ...
    <tr>
        ...
        <td>
            <img src="<?php echo plugins_url('', dirname(dirname(dirname(__FILE__)))) ?>/editor/css/images/tcb-logo-large.png" alt="" class="tve_ea_thrive_animation" id="tve-animation-target" />
        </td>
    </tr>
</table>
