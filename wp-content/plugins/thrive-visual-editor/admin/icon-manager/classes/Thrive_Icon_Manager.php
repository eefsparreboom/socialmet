    ...
    class Thrive_Icon_Manager
    {
        ...
        public function mainPage()
        {
            ...
            if (!empty($icon_pack['css'])) {
                wp_enqueue_style('thrive_icon_pack', $icon_pack['css']);
            }
        ...
        protected function enqueue()
        {
            ...
            wp_enqueue_media();
            wp_enqueue_script('thrive_icon_manager_options', dirname(plugin_dir_url(__FILE__)) . '/views/js/manager.js', array('jquery', 'media-upload', 'thickbox'));
            wp_enqueue_style('thrive_icon_manager_style', dirname(plugin_dir_url(__FILE__)) . '/views/css/manager.css');
        }
