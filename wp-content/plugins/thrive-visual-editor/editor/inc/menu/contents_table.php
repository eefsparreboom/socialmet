<span class="tve_options_headline">Table of Contents options</span>
<ul class="tve_menu">
    ...
    <li class="tve_ed_btn tve_btn_icon">
        <div title="Text align left" class="tve_icon tve_icon-30 tve_click" data-cls="tve_p_left" data-ctrl="controls.click.text_align"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div title="Text align center" class="tve_icon tve_icon-39 tve_click" data-cls="tve_p_center" data-ctrl="controls.click.text_align"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div title="Text align right" class="tve_icon tve_icon-40 tve_click" data-cls="tve_p_right" data-ctrl="controls.click.text_align"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div title="Text align justify" class="tve_icon tve_icon-41 tve_click" data-cls="tvealignjustify" data-ctrl="controls.click.text_align"></div>
    </li>
</ul>