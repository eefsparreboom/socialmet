<span class="tve_options_headline">Tabs options</span>
<ul class="tve_menu">
    ...
    <li class="tve_ed_btn tve_btn_text tve_firstOnRow">
        <div class="tve_option_separator">
            <span class="tve_ind tve_left" id="tabs_default_selected" data-default="Selected tab">Selected tab</span><span class="tve_caret tve_left" id="sub_02"></span>
