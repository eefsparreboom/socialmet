<span class="tve_options_headline">Table options</span>
<ul class="tve_menu">
    ...
    <li class="tve_ed_btn tve_btn_icon">
        <div id="tve_table_align_left" class="tve_icon tve_icon-30 btn_alignment" title="Text align left"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div id="tve_table_align_center" class="tve_icon tve_icon-39 btn_alignment" title="Text align center"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div id="tve_table_align_right" class="tve_icon tve_icon-40 btn_alignment" title="Text align right"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div id="tve_table_align_justify" class="tve_icon tve_icon-41 btn_alignment"
             title="Text align justify"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div id="tve_table_valign_top" class="tve_icon tve_icon-62 btn_alignment" title="Vertical align top"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div id="tve_table_valign_middle" class="tve_icon tve_icon-63 btn_alignment"
             title="Vertical align middle"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div id="tve_table_valign_bottom" class="tve_icon tve_icon-64 btn_alignment"
