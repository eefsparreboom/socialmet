<span class="tve_options_headline">Image options</span>
<ul class="tve_menu">
    <?php $has_custom_colors = true; $btn_class = 'tve_hidden_feature_grid'; include dirname(__FILE__) . '/_custom_colors.php' ?>
    ...
    <li class="tve_ed_btn_text clearfix tve_hidden_feature_grid">
    ...
    <li class="tve_ed_btn tve_btn_icon tve_hidden_feature_grid">
        <span class="tve_icon tve_icon-30 tve_click" id="img_left_align"></span>
    </li>
    <li class="tve_ed_btn tve_btn_icon tve_hidden_feature_grid">
        <span class="tve_icon tve_icon-39 tve_click" id="img_center_align"></span>
    </li>
    <li class="tve_ed_btn tve_btn_icon tve_hidden_feature_grid">
        <span class="tve_icon tve_icon-40 tve_click" id="img_right_align"></span>
    </li>
    ...
    <li class="tve_ed_btn">
        <span class="tve_click tve_lb_small tve_icon tve_icon-42" data-ctrl="controls.lb_open" id="lb_image_link"></span>
    </li>
    <!-- this only shows when the user clicks on a hyperlink -->
    <li class="tve_ed_btn tve_link_btns">
        <span class="tve_icon tve_icon-43 tve_click" data-ctrl="controls.click.image_unlink"></span>
    </li>
    ...
    <li class="tve_ed_btn tve_btn_text tve_hidden_feature_grid">
        <div class="tve_option_separator">
            ...
            <span id="sub_02" class="tve_caret tve_left"></span>
    ...
    <?php $li_custom_class = 'tve_hidden_feature_grid'; include dirname(__FILE__) . '/_event_manager.php'; unset($li_custom_class) ?>
