<span class="tve_options_headline">Thrive Lightbox options</span>
<ul class="tve_menu">
    ...
    <li class="tve_firstOnRow tve_ed_btn_text clearfix">
        <label class="tve_left" style="color: #878787">
            Max height:
            <input id="lightbox_max_height" class="tve_change" value="450" type="text" size="3" data-css-property="max-height" data-suffix="px"
                   data-size="1"> px&nbsp;&nbsp;
        </label>
    </li>
</ul>