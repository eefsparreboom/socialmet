<span class="tve_options_headline">Text element menu</span>
<ul class="tve_menu">
                ...
                <div class="tve_sub active_sub_menu color_selector" id="tve_sub_01_s">
                    ...
                    <div class="tve_color_picker tve_left">
                        ...
                        <div class="tve_remove_color_formatting tve_left">
                            <span class="tve_left tve_options_headline tve_click" data-ctrl="controls.text.remove_color" data-mode="foreground"><i class="tve_left tve_icon tve_icon-58"></i> Clear text color</span>
                        </div>
                        <div class="tve_clear"></div>
                    </div>
                    <div class="tve_clear"></div>
            ...
            <div class="tve_sub_btn tve_highlight_control">
                <div class="tve_sub active_sub_menu color_selector tve_sub_generic" id="tve_sub_01_s">
                    ...
                    <div class="tve_color_picker tve_left">
                        ...
                        <div class="tve_remove_color_formatting tve_left">
                            <span class="tve_left tve_options_headline tve_click" data-ctrl="controls.text.remove_color" data-mode="background"><i class="tve_left tve_icon tve_icon-58"></i> Clear highlight</span>
                        </div>
                        <div class="tve_clear"></div>
                    </div>
                    <div class="tve_clear"></div>
    ...
    <li class="tve_ed_btn tve_btn_icon">
        <div class="tve_icon tve_icon-34 tve_mousedown" data-ctrl="controls.rangy_cls" data-command="bold" title="Bold"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div class="tve_icon tve_icon-35 tve_mousedown" data-ctrl="controls.rangy_cls" data-command="italic" title="Italic"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div class="tve_icon tve_icon-36 tve_mousedown" data-ctrl="controls.rangy_cls" data-command="underline" title="Underline"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div class="tve_icon tve_icon-69 tve_mousedown" data-ctrl="controls.rangy_cls" data-command="strikethrough" title="Strike-through"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div class="tve_icon tve_icon-37 tve_click" id="text_bullet" title="Unordered List"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div class="tve_icon tve_icon-38 tve_click" id="text_numbered_bullet" title="Numbered List"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div class="tve_icon tve_icon-30 tve_click" title="Text align left" data-ctrl="controls.click.text_align" data-cls="tve_p_left"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div class="tve_icon tve_icon-39 tve_click" title="Text align center" data-ctrl="controls.click.text_align" data-cls="tve_p_center"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div class="tve_icon tve_icon-40 tve_click" title="Text align right" data-ctrl="controls.click.text_align" data-cls="tve_p_right"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <div class="tve_icon tve_icon-41 tve_click" title="Text align justify" data-ctrl="controls.click.text_align" data-cls="tvealignjustify"></div>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <span class="tve_click tve_lb_small tve_icon tve_icon-42 tve_mousedown" data-ctrl-click="controls.lb_open" data-ctrl-mousedown="controls.save_selection" data-key="linkSel" id="lb_text_link" title="Create link"></span>
    </li>
    <li class="tve_ed_btn tve_btn_icon">
        <span class="tve_icon tve_icon-54 tve_click" title="Insert more link" data-ctrl="controls.click.more_link"></span>
    </li>
    <li class="tve_ed_btn tve_btn_text">
        <div class="tve_option_separator">
            ...
            <div class="tve_sub_btn">
                <div class="tve_sub active_sub_menu">
                    <ul>
                        <li class="tve_click" data-ctrl="controls.click.block_change" data-tag="p">Paragraph</li>
                        <li class="tve_click" data-ctrl="controls.click.block_change" data-tag="address">Address</li>
                        <li class="tve_click" data-ctrl="controls.click.block_change" data-tag="pre">Preformatted</li>
                        <li class="tve_click" data-ctrl="controls.click.block_change" data-tag="blockquote">Blockquote</li>
                        <li class="tve_click" data-ctrl="controls.click.block_change" data-tag="h1">Heading 1</li>
                        <li class="tve_click" data-ctrl="controls.click.block_change" data-tag="h2">Heading 2</li>
                        <li class="tve_click" data-ctrl="controls.click.block_change" data-tag="h3">Heading 3</li>
                        <li class="tve_click" data-ctrl="controls.click.block_change" data-tag="h4">Heading 4</li>
                        <li class="tve_click" data-ctrl="controls.click.block_change" data-tag="h5">Heading 5</li>
                        <li class="tve_click" data-ctrl="controls.click.block_change" data-tag="h6">Heading 6</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <li>
        <input type="text" class="tve_change tve_text" placeholder="ID" data-ctrl="controls.change.element_id">
    </li>
    ...
    <li class="tve_ed_btn tve_link_btns">
        <span class="tve_icon tve_icon-43 tve_click" data-ctrl="controls.text_unlink"></span>
    </li>
