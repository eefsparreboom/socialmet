...
class Optin_Monster_Common {
    ...
    public function get_optin_status_link( $meta, $optin_id ) {
        ...
        switch ( $status ) {
            case 'live' :
                $link = '<span class="om-disable"><a href="' . add_query_arg( array( 'om_optin_id' => $optin_id, 'om_action' => 'disable' ), admin_url( 'admin.php?page=optin-monster-settings' ) ) . '" title="' . __( 'Disable this optin', 'optin-monster' ) . '">' . __( 'Disable', 'optin-monster' ) . '</a></span>';
                break;
            case 'staging' :
                ...
                break;
            case 'disabled' :
                $link = '<span class="om-enable"><a href="' . add_query_arg( array( 'om_optin_id' => $optin_id, 'om_action' => 'live' ), admin_url( 'admin.php?page=optin-monster-settings' ) ) . '" title="' . __( 'Make this optin go live', 'optin-monster' ) . '">' . __( 'Go Live', 'optin-monster' ) . '</a></span>';
                break;
        }
